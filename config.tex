...
% custom style for listings for python
...
\lstdefinelanguage{Julia}{
  morekeywords={
  abstract,break,case,catch,const,continue,do,else,elseif,end,export,false,for,function,global,if,import,let,local,macro,module,quote,return,true,try,using,while,mutable,struct,begin
  },
  sensitive=true,
  morecomment=[l]\#,
  morestring=[b]",
...
% custom style for listings for julia
...
\lstdefinestyle{cppstyle}{
  ...
  % additional options:
  keepspaces     = true,
  % you can add more C++-specific keywords if needed
  morekeywords   = {nullptr, override, final, auto, template, typename}
}
...
% decide color of diagonal strikeout line: use as \cancel{}
\usepackage{cancel}
...
\usepackage{parskip}
\usepackage{amssymb,amsmath,amsthm,amsfonts,mathtools,bm,bbm,centernot}
...
% Colored code snippet
\newcommand{\code}[1]{\textcolor{red}{\textbf{\texttt{#1}}}}
...
\DeclareRobustCommand{\allbf}[1]{\ifmmode\bm{#1}\else\textbf{\boldmath #1}\fi}
